...
class Employee(db.Model):
    ...
    pto_vacation_accrual_rate = db.Column(db.Numeric(6, 2), default=0)
    pto_sick_accrual_rate = db.Column(db.Numeric(6, 2), default=0)
    pto_personal_accrual_rate = db.Column(db.Numeric(6, 2), default=0)
